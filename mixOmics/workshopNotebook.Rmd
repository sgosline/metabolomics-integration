...
```{r network assumbly, warning=FALSE,error=FALSE,message=FALSE}

##load in metabolic network
allkeggpaths<-readr::read_csv('https://raw.githubusercontent.com/sgosline/metabolomics-integration/main/mixOmics/keggPathList.csv')|>
  subset(Entry!='Entry')


##this is a full network for all proteins/metabolites
fullNetwork<-getMetNetworksForNodes(setdiff(metloads$compoundId,NA),allkeggpaths$Entry)
